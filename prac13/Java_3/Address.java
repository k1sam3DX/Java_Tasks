...
public class Address {
    ...
    public static void main(String[] args) {
        ...
        Address a2 = new Address("UK, London, London, Trafalgar square, 2, 3, 4, other string,,,", false);
        Address a3 = new Address("Germany,       Freistaat Bayern', Aiterhofen.    Esplanade 45; 13;1;2", true);
